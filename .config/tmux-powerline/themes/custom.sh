...
# Solarized Dark palette. Use hex values for the status background so tmux does
# not depend on terminal-specific 256-color approximations.
TMUX_POWERLINE_SOLARIZED_BASE03="#002b36"
TMUX_POWERLINE_SOLARIZED_BASE0="#839496"
TMUX_POWERLINE_SOLARIZED_CYAN="#2aa198"

TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR:-$TMUX_POWERLINE_SOLARIZED_BASE03}
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-$TMUX_POWERLINE_SOLARIZED_BASE0}
...
# Render the window list through tmux's native window-status machinery. Keeping
# windows out of status-left avoids clipping long window names at
# TMUX_POWERLINE_STATUS_LEFT_LENGTH and lets tmux handle focus/selection ranges.
# shellcheck disable=SC2128
TMUX_POWERLINE_WINDOW_STATUS_CURRENT=(
  "#[fg=$TMUX_POWERLINE_SOLARIZED_BASE03,bg=$TMUX_POWERLINE_SOLARIZED_CYAN,nobold,noitalics,nounderscore]"
  "$TMUX_POWERLINE_DEFAULT_LEFTSIDE_SEPARATOR"
  " #I#F "
  "$TMUX_POWERLINE_SEPARATOR_RIGHT_THIN"
  " #W#{?@workmux_status, #{@workmux_status},} "
  "#[fg=$TMUX_POWERLINE_SOLARIZED_CYAN,bg=$TMUX_POWERLINE_SOLARIZED_BASE03,nobold,noitalics,nounderscore]"
  "$TMUX_POWERLINE_DEFAULT_LEFTSIDE_SEPARATOR"
)
# shellcheck disable=SC2128
TMUX_POWERLINE_WINDOW_STATUS_STYLE=(
  "fg=$TMUX_POWERLINE_SOLARIZED_BASE0,bg=$TMUX_POWERLINE_SOLARIZED_BASE03,nobold,noitalics,nounderscore"
)
# shellcheck disable=SC2128
